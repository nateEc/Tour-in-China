...
function initialiseFloatingImages()
{
    ...
    for (var i = 0; i < imageCount; i++) {
        ...
        // write layers etc...
        if (ns4up) {
            document.write('<layer name="dot'+i+'" left="15" top="15" visibility="show"><img src="mt.png" alt="Floating image"/></layer>');
        } else if (ie4up||ns6up) {
            document.write('<div id="dot'+i+'" style="POSITION:absolute; Z-INDEX:'+i+'; VISIBILITY:visible; TOP:15px; LEFT:15px;"><img src="mt.png" alt="Floating image"/></div>');
        }
    }
